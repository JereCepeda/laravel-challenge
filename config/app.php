...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The application provides a number of service providers that are used
    | to bind services to the application. These providers are the default
    | providers that are included with Laravel.
    |
    */
